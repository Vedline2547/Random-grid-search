...
# Evaluaste best model
best_grid_model = grid_search.best_estimator_
y_pred_grid = best_grid_model.predict(X_test)
accuracy_grid = accuracy_score(y_test,y_pred_grid)
print(f"Best Hyper Parameters(Grid Search): {grid_search.best_params_}")
...
print(f"Best Hyper Parameters(Random Search): {random_search.best_params_}")
print(f"Grid Search Accuracy: {accuracy_random}")
